...
public class btck_DestroyCallback {
    ...
    private static final MethodHandle UP$MH = bitcoinkernel_h.upcallHandle(btck_DestroyCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(btck_DestroyCallback.Function fi, Arena arena) {
