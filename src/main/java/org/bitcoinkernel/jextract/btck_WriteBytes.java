...
public class btck_WriteBytes {
    ...
    public interface Function {
        int apply(MemorySegment bytes, long size, MemorySegment userdata);
    }
    ...
    private static final MethodHandle UP$MH = bitcoinkernel_h.upcallHandle(btck_WriteBytes.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(btck_WriteBytes.Function fi, Arena arena) {
