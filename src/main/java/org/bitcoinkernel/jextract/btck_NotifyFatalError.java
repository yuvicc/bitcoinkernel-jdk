...
public class btck_NotifyFatalError {
    ...
    private static final MethodHandle UP$MH = bitcoinkernel_h.upcallHandle(btck_NotifyFatalError.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(btck_NotifyFatalError.Function fi, Arena arena) {
