...
public class btck_LogCallback {
    ...
    private static final MethodHandle UP$MH = bitcoinkernel_h.upcallHandle(btck_LogCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(btck_LogCallback.Function fi, Arena arena) {
